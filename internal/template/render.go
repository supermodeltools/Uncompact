...
{{end}}{{- end}}{{- end}}
---
*Generated by [Uncompact](https://github.com/supermodeltools/Uncompact)*{{if .WorkingMemory}}

## Working Memory

**Branch:** {{.WorkingMemory.Branch}}{{if .WorkingMemory.IssueNumber}}
**Issue #{{.WorkingMemory.IssueNumber}}{{if .WorkingMemory.IssueTitle}}:** {{.WorkingMemory.IssueTitle}}{{else}}**{{end}}{{if .WorkingMemory.IssueBody}}
> {{.WorkingMemory.IssueBody}}{{end}}{{end}}
{{if .WorkingMemory.ChangedFiles}}
**Changes on branch (vs main):**
{{range .WorkingMemory.ChangedFiles}}  {{.}}
{{end}}{{end}}{{if .WorkingMemory.BranchCommits}}**Recent commits:**
{{range .WorkingMemory.BranchCommits}}  {{.}}
{{end}}{{end}}{{if .WorkingMemory.Uncommitted}}**Uncommitted:**
{{range .WorkingMemory.Uncommitted}}  {{.}}
{{end}}{{end}}{{end}}`
